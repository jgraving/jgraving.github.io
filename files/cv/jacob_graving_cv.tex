...
\documentclass[letterpaper,6pt,oneside]{article}
...
& Computational models for animal behavior, Bayesian statistical inference, machine/deep learning, probabilistic programming, nonlinear dynamics \vspace{2mm}\\ 
